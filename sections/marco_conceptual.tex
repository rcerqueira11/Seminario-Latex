...
\begin{itemize}
	...
	\item El mimsmo codigo base reutilizable en multiples plataformas 
	
	\item Proceso de desarrollo mas senciolo y economico 
	
	\item No necesitan ninguna aprobacion para publicarse ( a diferencia de las nativas para estar visibles en la app store)
	
	\item El usuario siempre dispone de la ultima version 
	
	\item Pueden reutilizarse sitios "resposive" ya dise;ados
...
\begin{itemize}
	...
	\item Requiere de conexion a internet
	
	\item Acceso muy limitado a los elementos y caracteristicas del hardware del dispositivo
	
	\item La experiencia del usuario (navigacion, interaccion) y el tiempo de respuesta es menor en una app nativa
	
	\item Requiere de mayor esfuerzo en promocion y visibilidad
...
\begin{itemize}
	...
	\item Instalacion nativa pero construida con JavaScript, HTML y CSS
	
	\item El mismo codigo base para multiples plataformas
...
\begin{itemize}
	...
	\item Experiencia del usuario mas propia de la palicacion web que de la app nativa
	
	\item Dise;o visual no siempre relacionado ocn el sistema operativon en el que se muestre.
